...
bias_Jack = (Count-1)*(Jack_mean-Data_mean);
...
Result = Data_mean || Jack_mean || bias_Jack || Error_Jack;
print Result[c={"Mean length of seals" "Estimate of Mean Jackknife " "Bias" "Standard Error"}];
```
